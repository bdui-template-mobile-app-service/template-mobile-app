...
class BaseViewFacade implements ComponentFacade {
  @override
  String componentType() => "View";
  ...
  Widget? makeWidgetFromPayload(
    ...
    if (componentPayload is BaseViewPayload) {
  ...
  IComponentRemotePayload? makeDefaultedForCanvas() {
    return BaseViewPayload(width: 200, height: 200, color: "000000");
  }

  @override
  IComponentRemotePayload? payloadFromJson(Map<String, dynamic> json) =>
      BaseViewPayload.fromJson(json);
