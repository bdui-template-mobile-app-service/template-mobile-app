...
class _RestClient implements RestClient {
  ...
  Future<List<MenuItem>> fetchMenuItems() async {
    ...
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<MenuItem>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<PromotionItem>> fetchPromotions() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PromotionItem>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AboutCompanyInfo> fetchAboutCompanyInfo() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AboutCompanyInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
